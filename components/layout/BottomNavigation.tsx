            ...
            <div className="mx-auto grid max-w-md grid-cols-5 gap-1">
                {navigationItems.map((item) => (
                    <Link
                        key={item.href}
                        href={item.href}
                        className="flex flex-col items-center gap-1 rounded-2xl px-2 py-2 text-xs font-medium text-stone-500 transition hover:bg-orange-50 hover:text-orange-600"
                    >
